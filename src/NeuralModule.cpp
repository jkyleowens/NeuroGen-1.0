...
bool NeuralModule::initialize_cuda_resources() {
    ...
    try {
        ...
        if (error != cudaSuccess || device_count == 0) {
            std::cout << "❌ [CUDA Init] CUDA not available for module '" << module_name_
        ...
        std::cout << "✅ [CUDA Init] CUDA available! Initializing GPU for module '" << module_name_
        ...
        std::cout << "  ⚡ CUDA Cores: " << prop.multiProcessorCount * 64 << std::endl;
